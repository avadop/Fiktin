          ...
          >
            ...
            <div>
              <div class="buttons-div">
                <b-button v-if="modifyID !== book.ID && !book.confirmDelete" style="font-size: 16px;" v-b-tooltip.hover title="Eliminar" variant="light" @click.stop="book.confirmDelete=true"><b-icon icon="trash-fill"/></b-button>
                <b-button v-else-if="book.confirmDelete" variant="danger" style=" font-size: 16px; background-color: #dc3545 !important" v-b-tooltip.hover title="Confirmar eliminar" @click.stop="deleteBook(book.ID, idx)"><b-icon icon="trash-fill"/></b-button>
