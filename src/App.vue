<template>
  <div id="app">
      ...
      <b-navbar toggleable="lg"  class="navbar-color">
        ...
        <b-collapse v-if="loggedIn" id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-item style="font-size: 16px;"><router-link to="/user" class="h4 nav-ref" ><b-icon icon="person"></b-icon></router-link></b-nav-item>
            <b-nav-item style="font-size: 16px;"><div @click="confirmLogOut" class="h4 nav-ref"><b-icon icon="power"></b-icon></div></b-nav-item>
          </b-navbar-nav>
        </b-collapse>
        ...
        <b-collapse v-else id="nav-collapse" is-nav>
          ...
          <!-- Right aligned nav items -->
          <b-navbar-nav class="ml-auto">
            <b-nav-item @click="needLogIn('/')" style="font-size: 16px;"><div class=" h4 nav-ref" style="font-size: 16px;"><b-icon icon="person"></b-icon></div></b-nav-item>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
    ...
    <b-modal v-model="modalLogOut" hide-footer hide-header no-close-on-backdrop>
        ...
        <b-button class="mt-3" variant="outline-danger" block @click="logOut" style="font-size: 16px;">Si</b-button>
